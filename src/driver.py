...
def main(argv):
	...
	try :
		...
		print("Cannot find batch file, make sure to put batch_payment.txt into ./paymo_input/ or specify your argument as starting from digital-wallet/.")
		sys.exit()
	...
	try:
		...
		print("Cannot find stream file, make sure to put stream_payment.txt into ./paymo_input/ or specify your argument as starting from digital-wallet/. correctly")		
