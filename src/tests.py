...
class ParserTests(unittest.TestCase):
	def test_parse(self):
		parser = file_parser()
		try:
			payments = parser.parse_file("./paymo_input/batch_payment.txt")
			payments = parser.parse_file("./paymo_input/stream_payment.txt")
			self.assertTrue(True)
			
		except:
			print ("./paymo_input/batch_payment.txt and/or ./paymo_input/stream_payment.txt MISSING")
